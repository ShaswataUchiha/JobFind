    ...
    <div className="p-6 rounded-xl shadow-lg bg-white border border-gray-200 hover:shadow-2xl transition-shadow duration-300 ease-in-out">
      ...
      <div className="flex items-center gap-4 my-4">
        <Avatar className="p-3 rounded-md shadow-sm border">
          <AvatarImage src="https://www.thepixelfreak.co.uk/wp-content/uploads/2019/05/Entwined-M-Logo.png" alt="Company Logo" />
        </Avatar>
        <div>
          <h1 className="font-semibold text-lg md:text-xl text-gray-800">Company Name</h1>
      ...
      <div className="mb-4">
        <h1 className="font-bold text-xl md:text-2xl text-gray-800 my-2">Job Title</h1>
        <p className="text-sm md:text-base text-gray-600 line-clamp-3">
          A brief description of the job role goes here. Lorem ipsum dolor sit amet, consectetur
      ...
      <div className="flex flex-col sm:flex-row gap-3 mt-6">
        <Button variant="outline" className="w-full sm:w-auto hover:bg-blue-50 text-blue-700 border-blue-700">
          View Details
        </Button>
